...
class RIS_SDMA_Precoding(nn.Module): #单层
    def __init__(self, parm_set): 
        ...
        self.trans2  = TRANS_BLOCK(2*K*K,4*K+1,256,3) #4×4等效信道
    ...
    def forward(self, H,parm_set):
        ...
        F_BB_SDMA = F_BB_SDMA.reshape([Nc,batch,K,K])
        F_SDMA = F_RF @ F_BB_SDMA  #[batch,Nc,M_ant,K]         [batch,Nt,K] * [Nc,batch,K,K] = [Nc,batch,Nt,K]广播机制
